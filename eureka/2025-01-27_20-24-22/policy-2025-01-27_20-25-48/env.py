...
class FrankaCabinetGPT(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = compute_reward(self.hand_pos, self.drawer_pos, self.hand_rot, self.drawer_rot, self.franka_lfinger_pos, self.franka_rfinger_pos, self.franka_dof_pos, self.cabinet_dof_pos)
