...
class FrankaCabinetGPT(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = compute_reward(self.franka_grasp_pos, self.drawer_grasp_pos, self.cabinet_dof_pos, self.franka_grasp_rot, self.drawer_grasp_rot)
